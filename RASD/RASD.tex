...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \subsection{Revision history}
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Version 1.1: Corrections and additions
            \begin{itemize}
                \item[--] Changed a wrong png path in the document (Fig \ref{fig: View nearby stations})
                \item[--] Modified the Bpmn of Battery and navigation system suggestions to show the correct interaction between the eMSP and the EV (Fig \ref{fig: Battery and navigation suggestions}) 
                \item[--] Small clarification about the OCPI protocol in the communication interface section
                \item[--] Added missing CAR API interface in the eMSP UML (Fig \ref{fig: UML EMSP})
            \end{itemize}
        \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \stepcounter{assumptionCtr}D\arabic{assumptionCtr}: User's EV works properly while charging
        ...
        \item \stepcounter{assumptionCtr}D\arabic{assumptionCtr}: The data supplied by the user's devices are correct (such as current position)
        ...
        \item \stepcounter{assumptionCtr}D\arabic{assumptionCtr}: EV battery status can be accessed by the app through the API
       \end{itemize}
    ...
    To access the application a web browser is required. Additional software like a calendar and GPS is necessary for accessing all the functionalities of the application. The software will also take advantage of some interfaces to accomplish its requirements. An external API is necessary to visualize on maps the user location and the near charging stations. %frase copiatissima%
    ...
    \begin{itemize}
        \item \textbf{Communication between the EMSP and the CPMS:}\\
              Will be done through the OCPI protocol that allows synchronous (Real Time Protocol RTC) and asynchronous operations between the two parties, and supports both peer-to-peer (P2P) and roaming hub connections.\\
    ...
    \begin{longtable}{|c|p{0.69\textwidth}|}
        ...
        \stepcounter{RequirementCtr}%R11
        ...
        \stepcounter{RequirementCtr}%R12
    ...
    \begin{longtable}{|c|p{0.69\textwidth}|}
        ...
        \stepcounter{RequirementCtr}%R23
        ...
        \stepcounter{RequirementCtr}%R24
        ...
        \stepcounter{RequirementCtr}%R25
        ...
        \stepcounter{RequirementCtr}%R26
        ...
        \stepcounter{RequirementCtr}%R27
            ...
            \begin{table}[H]
                ...
                \begin{tabular}{|c |m{0.69\textwidth}|}
                    ...
                    \textbf{Flow of events} & \begin{enumerate}
                                                ...
                                                \item CPOW (selects a specific station and) clicks on "switch to internal battery"
...
R12
    ...
    \end{itemize}
        ...
        \begin{itemize}
            ...
            \begin{center}
                \begin{figure}[H]
                    \includegraphics[scale=0.55, center]{assets/sequenceDiagrams/View Map.png}
