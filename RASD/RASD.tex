...
R12
    ...
    For Italy the trend is also positive with 32 thousand electric cars registered in 2021, and 67 thousand in 2020 \cite{EV registrations}.\\
    ...
    \begin{itemize}
        ...
        \item \textbf{(G6) Suggest the user convenient charging timeframes based on his upcoming schedule or on his planned trip. }: With two assertions we verify that the system correctly suggests to each user specific timeframes taken from their schedule where they can charge their EV based on the proximity to a charging station. We also check that the system also correctly suggest, based on the user's next trip, some charging stations along the route.
