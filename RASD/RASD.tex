...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \begin{itemize}
        ...
        \item \stepcounter{assumptionCtr}D\arabic{assumptionCtr}: Car battery status can be accessed by the app through the API
       \end{itemize}
    ...
    \begin{table}[H]
        \begin{center}
            \begin{tabular}{|c | p{0.69\textwidth}|}
                ...
                \cellcolor{green!50}D2 & The infrastructure of the charging stations is reliable and works 99\% of the time.\\\hline
                \cellcolor{green!50}D3 & User's car works properly while charging.\\\hline
                \cellcolor{green!50}D4 & Information about the charging stations offered by the CPMS are accurate (such as position, state and availability ).\\\hline
                \cellcolor{green!50}D5 & The DSO's infrastructure is working and their data is reliable.\\\hline
                \cellcolor{green!50}D12 & The eMSPs and all the connected CPMSs follow the OCPI 2.2.1 protocol.\\\hline
                \cellcolor{green!50}D13 & Car battery status can be accessed by the app through the API.\\\hline
            \end{tabular}
        \end{center}
    \end{table}
    ...
    For more details \ref{sequencediagram}.
        ...
        \item[] \begin{longtable}{|p{0.31\textwidth}|p{0.69\textwidth}|}
                    ...
                    R27) The CPMS subsystem must retrieve the battery status of the car through the DIN/ISO specications.
                    \\\hline
