...
class DiscountManager(models.Model):
    ...
    def create_discount(self, start_date, end_date, discount_amount):
        if not start_date:
...
class Discount(models.Model):
    ...
    REQUIRED_FIELDS = ['start_date','end_date', 'discount_amount'] #Every field is required for the discount to be registered.
