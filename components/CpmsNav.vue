      ...
      <div class="relative flex grid items-center grid-cols-2 lg:grid-cols-3">
        ...
        <ul class="flex items-center hidden ml-auto space-x-8 lg:flex">
          <li v-if="logged">
            <a
              href="/"
              class= "inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-orange-500 hover:bg-orange-700 focus:shadow-outline focus:outline-none"
              aria-label="Sign up"
              title="Sign up"
              @click="logout"
            >
        ...
        <div class="z-1 ml-auto lg:hidden">
          ...
          <div v-if="isMenuOpen" class="absolute top-0 left-0 w-full" style="z-index: 99;">
